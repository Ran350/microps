...
struct sched_ctx {
    pthread_cond_t cond;  // conditional variable to be used to suspend threads
    int interrupted;  // flag indicating that the signal has been interrupted
    int wc;           // count of suspended tasks
};
...
extern int sched_sleep(struct sched_ctx *ctx, mutex_t *mutex,
