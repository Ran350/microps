...
struct ip_route {
    ...
    ip_addr_t nexthop;       // next hop address, or IP_ADDR_ANY
    struct ip_iface *iface;  // interface to send to this route
};
...
static struct ip_protocol *protocols;  // ip protocol list
